...
@section('master')
    ...
    <div class="top-header">
        <div class="page-title">
            ...
            <p class="page-subtitle">Completed and archived projects - {{ $type }}</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between mb-3">
                        <div class="d-flex flex-wrap gap-2">
                            <a class="btn btn-primary btn-sm" href="{{ route("admin.review.projectsPending", ["type" => $type]) }}">
                                <i class="mdi mdi-arrow-left"></i> Back to Pending Projects
                            </a>

                            <div class="vr" style="height: 30px; background: var(--border-color);"></div>

                            <a class="btn btn-info btn-sm" href="{{ route("admin.review.projectsArchive", ["type" => "My"]) }}">
                                <i class="mdi mdi-archive"></i> My
                            </a>
                            <a class="btn btn-info btn-sm" href="{{ route("admin.review.projectsArchive", ["type" => "Client1"]) }}">
                                <i class="mdi mdi-archive"></i> Client1
                            </a>
                            <a class="btn btn-info btn-sm" href="{{ route("admin.review.projectsArchive", ["type" => "Client2"]) }}">
                                <i class="mdi mdi-archive"></i> Client2
                            </a>
                        </div>
                    </div>
                ...
                noResultsMessage.innerHTML = `
                    <div class="card">
                        <div class="card-body text-center py-5">
                            ...
                            <p class="text-muted">No archived projects found with ASIN containing "<strong>${asin}</strong>"</p>
    ...
    <div class="row">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    ...
                                    <span class="badge badge-info">
                                        <i class="mdi mdi-check-all"></i> Archived
                                    </span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mb-3 p-3 rounded" style="background: var(--dark-bg); border: 1px solid var(--border-color);">
                                ...
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                    ...
                                    <span>
                                        ...
                                        @elseif($review["status"] === 'delete')
                                            <span class="badge" style="background: rgba(148, 163, 184, 0.2); color: var(--dark-text-muted);">
        ...
        @empty
            <div class="col-12">
                <div class="card">
                    <div class="card-body text-center py-5">
                        <i class="mdi mdi-archive-outline" style="font-size: 64px; color: var(--dark-text-muted);"></i>
                        <h4 class="mt-3">No Archived Projects</h4>
                        <p class="text-muted">There are no archived projects for {{ $type }}</p>
                        <a href="{{ route("admin.review.projectsPending", ["type" => $type]) }}" class="btn btn-primary mt-3">
                            <i class="mdi mdi-arrow-left"></i> Back to Pending Projects
                        </a>
                    </div>
                </div>
